...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 z-10 flex w-full items-center justify-between border-b border-b-gray-700 bg-black/70 px-9 py-6 text-white backdrop-blur-md md:justify-evenly">
      <a
        href="#home"
