...
const Projects = () => {
  return (
    <div
      id="projects"
      className="flex min-h-screen, w-[90%] flex-col items-center justify-start gap-16, p-0 md:px-14 py-14 text-justify"
    >
      <ScrollReveal>
      ...
      <div className="flex w-full  max-w-[1000px] flex-col gap-16 text-white mx-auto md:px-11">
